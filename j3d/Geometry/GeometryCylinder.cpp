...
Mesh3D::Geometry GeometryCylinder::create(Params& p)
{
	Mesh3D::Geometry g;
...
Mesh3D::Geometry GeometryCylinder::create(float rTop, float rBottom, float h, unsigned int rSegments, unsigned int hSegments, bool open, float tStart, float tLength)
{
    auto params = Params{ rTop, rBottom, h, rSegments, hSegments, open, tStart, tLength };
