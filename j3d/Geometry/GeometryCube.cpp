...
namespace
{
    ...
    public:
		...
		void buildPlane(Mesh3D::Geometry& g, int u, int v, int w, float udir, float vdir,
		...
		CubeHelper(Mesh3D::Geometry& g, GeometryCube::Params& p)
		{
...
Mesh3D::Geometry GeometryCube::create(Params& params)
{
...
Mesh3D::Geometry GeometryCube::create(float width, float height, float depth, unsigned int widthSegments, unsigned int heightSegments, unsigned int depthSegments)
{
	Mesh3D::Geometry geometry;

    auto params = Params{ width, height, depth, widthSegments, heightSegments, depthSegments };
